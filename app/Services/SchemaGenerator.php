...
class SchemaGenerator
{
    ...
    public static function websiteEntity(): array
    {
        return [
            ...
            'url' => url('/'),
            'name' => 'Ashma Creations',
            'description' => 'Discover unique handmade gifts, personalized creations, home decor and thoughtful keepsakes at Ashma Creations. Beautifully handcrafted with creativity and care for every special moment.',
            'inLanguage' => 'en',
            'publisher' => [
                '@id' => url('/') . '#organization',
            ],
    ...
    protected static function forHomepage(StaticPage $page, string $canonicalUrl): array
    {
        ...
        $webPage = [
            ...
            '@id' => $canonicalUrl,
            'url' => $canonicalUrl,
            'name' => $page->meta_title ?? ($page->title ?? 'Ashma Creations'),
            'description' => $page->meta_description ?? 'Discover unique handmade gifts, personalized creations, home decor and thoughtful keepsakes at Ashma Creations. Beautifully handcrafted with creativity and care for every special moment.',
            'inLanguage' => 'en',
