    ...
    <aside id="admin-sidebar" class="fixed inset-y-0 left-0 z-30 w-64 md:relative md:translate-x-0 transform -translate-x-full bg-white border-r border-primary-light/10 flex-shrink-0 flex flex-col transition-all duration-300 ease-in-out">
        ...
        <nav class="flex-grow p-6 space-y-2">
            ...
            <a href="{{ route('admin.collections.index') }}" 
               class="flex items-center px-4 py-3 rounded-2xl text-sm font-semibold transition-all group {{ request()->routeIs('admin.collections.*') ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-background hover:text-primary' }} justify-start sidebar-link">
                <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->routeIs('admin.collections.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                </svg>
                <span class="nav-text ml-3 transition-opacity duration-300">Collections</span>
            </a>

            <a href="{{ route('admin.taxonomies.index', 'occasions') }}" 
               class="flex items-center px-4 py-3 rounded-2xl text-sm font-semibold transition-all group {{ request()->is('admin/taxonomies/occasions*') ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-background hover:text-primary' }} justify-start sidebar-link">
                <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->is('admin/taxonomies/occasions*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span class="nav-text ml-3 transition-opacity duration-300">Occasions</span>
            </a>

            <a href="{{ route('admin.taxonomies.index', 'recipients') }}" 
               class="flex items-center px-4 py-3 rounded-2xl text-sm font-semibold transition-all group {{ request()->is('admin/taxonomies/recipients*') ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-background hover:text-primary' }} justify-start sidebar-link">
                <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->is('admin/taxonomies/recipients*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
                <span class="nav-text ml-3 transition-opacity duration-300">Recipients</span>
            </a>

            <a href="{{ route('admin.taxonomies.index', 'styles') }}" 
               class="flex items-center px-4 py-3 rounded-2xl text-sm font-semibold transition-all group {{ request()->is('admin/taxonomies/styles*') ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-background hover:text-primary' }} justify-start sidebar-link">
                <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->is('admin/taxonomies/styles*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                </svg>
                <span class="nav-text ml-3 transition-opacity duration-300">Styles</span>
            </a>

            <a href="{{ route('admin.taxonomies.index', 'materials') }}" 
               class="flex items-center px-4 py-3 rounded-2xl text-sm font-semibold transition-all group {{ request()->is('admin/taxonomies/materials*') ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-background hover:text-primary' }} justify-start sidebar-link">
                <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->is('admin/taxonomies/materials*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
                </svg>
                <span class="nav-text ml-3 transition-opacity duration-300">Materials</span>
            </a>
            ...
            <a href="{{ route('admin.homepage.hero-banners.index') }}" 
               class="flex items-center px-4 py-3 rounded-2xl text-sm font-semibold transition-all group {{ request()->routeIs('admin.homepage.hero-banners.*') ? 'bg-primary/10 text-primary' : 'text-gray-600 hover:bg-background hover:text-primary' }} justify-start sidebar-link">
                <svg class="w-5 h-5 flex-shrink-0 transition-colors {{ request()->routeIs('admin.homepage.hero-banners.*') ? 'text-primary' : 'text-gray-400 group-hover:text-primary' }}" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                </svg>
                <span class="nav-text ml-3 transition-opacity duration-300">Banners</span>
            </a>
