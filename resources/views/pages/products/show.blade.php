                ...
                <div class="lg:w-1/2">
                    ...
                    <div class="bg-primary/5 rounded-[2.5rem] p-10 border border-primary-light/20">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            <a href="https://wa.me/yournumber?text=Hi, I am interested in {{ $product->name }}" target="_blank" class="flex-1 flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366] text-white font-body font-bold rounded-full hover:bg-[#128C7E] transition-all transform hover:-translate-y-1 shadow-lg">
