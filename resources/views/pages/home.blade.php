    ...
    <section class="relative py-24 md:py-32 overflow-hidden bg-white">
        ...
        <div class="hidden lg:block absolute top-1/2 right-4 -translate-y-1/2 w-1/3">
            <div class="relative">
                ...
                <div class="absolute top-0 right-0 text-accent animate-bounce animate-duration-4s">
                ...
                <div class="absolute bottom-10 -left-10 text-secondary animate-pulse animate-duration-3s">
