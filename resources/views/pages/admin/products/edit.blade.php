            ...
            <form method="POST" action="{{ route('admin.products.update', $product->slug) }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="price" type="number" step="0.01" min="0" name="price" value="{{ old('price', $product->price) }}" placeholder="e.g., 65"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="weight" type="number" step="0.1" min="0" name="weight" value="{{ old('weight', $product->weight ? (float)$product->weight : '') }}" placeholder="e.g., 350"
