            ...
            <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-3 gap-4 sm:gap-6">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="length" type="number" step="0.1" min="0" name="length" value="{{ old('length') }}" placeholder="e.g., 15"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="height" type="number" step="0.1" min="0" name="height" value="{{ old('height') }}" placeholder="e.g., 30"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input id="width" type="number" step="0.1" min="0" name="width" value="{{ old('width') }}" placeholder="e.g., 10"
