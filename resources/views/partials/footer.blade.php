        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-16">
            ...
            <div class="lg:col-span-2">
                ...
                <p class="text-soft-gray font-body text-sm leading-relaxed max-w-sm mb-6">
                    Crafting everlasting pipe cleaner bouquets, flower pots, custom gifts, and decor. Each creation is handcrafted with artistic care to bring joy and lasting memories.
                </p>
                <div class="flex items-center space-x-3 text-xs font-body text-soft-gray">
                    <span class="px-3 py-1 bg-primary-light/10 text-primary rounded-full font-bold">100% Handcrafted</span>
                    <span class="px-3 py-1 bg-secondary/15 text-primary rounded-full font-bold">Custom Orders</span>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-2.5 font-body text-xs text-charcoal">
                    ...
                    <li><a href="{{ route('occasions.index') }}" class="hover:text-primary transition-colors">Gifts for Every Occasion</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-col space-y-3">
                    ...
                    <a href="https://wa.me/917728879509" target="_blank" rel="noopener" class="flex items-center space-x-3 text-xs text-charcoal hover:text-primary transition-colors group">
                        ...
                        <span class="font-body">WhatsApp Inquiry</span>
                    </a>
                </div>
            </div>
        </div>
